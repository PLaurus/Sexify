...
sealed interface Markup {
	object Package : MultiMark(listOf("_M_PACKAGE_0_", "_M_PACKAGE_1_"))
	...
	object NameSnake : Mark("_m_name_snake_") // This mark must be in snake case! (it is used in layout naming).
